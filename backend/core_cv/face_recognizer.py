...
class FaceRecognizer:
    def __init__(self, app=None, threshold=None):
        ...
        # known_faces: face_id -> face/user identity and embedding metadata
        self.known_faces = {}
            ...
            with self.app.app_context():
                ...
                for face in faces:
                    ...
                    try:
                        ...
                        logger.error(f"Error parsing face feature for face ID {face.id}: {fe}")
    ...
    def detect_and_recognize_in_person(self, frame, person_box, track_id=None):
        ...
        try:
            ...
            with self._lock:
                for face_id, info in self.known_faces.items():
                    ...
                    if is_arcface:
                        ...
                        if sim >= self.threshold:
                            if best_match_id is None or sim > max_sim:
                                max_sim = sim
                                best_match_id = info.get("user_id", face_id)
